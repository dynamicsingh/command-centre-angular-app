...
var paths = {
    ...
    php: './app/php_components/**/*',
    distphp: './dist.dev/php_components',
...
pipes.processedPhpDev = function() {
    return gulp.src(paths.php)
        .pipe(gulp.dest(paths.distDev + '/php_components/'));
};

pipes.processedPhpProd = function() {
    return gulp.src(paths.php)
        .pipe(gulp.dest(paths.distProd + '/php_components/'));
};
...
pipes.builtAppDev = function() {
    return es.merge(pipes.builtIndexDev(), pipes.builtPartialsDev(), pipes.processedImagesDev(), pipes.processedFontsDev(),pipes.processedPhpDev());
};

pipes.builtAppProd = function() {
    return es.merge(pipes.builtIndexProd(), pipes.builtPartialsProd(), pipes.processedImagesProd(), pipes.processedFontsProd(),pipes.processedPhpProd());
};
...
gulp.task('dev', ['clean-build-app-dev', 'validate-devserver-scripts'], function() {
    ...
    // watch php components
    gulp.watch(paths.php, function() {
        return pipes.builtPHPDev()
            .pipe(plugins.livereload());
    });
